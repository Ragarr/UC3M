...
def palindromo(palabra:str):
    '''Problem 1 - Checking palindrome words by using a doubly linked list.
    A palindrome word is one that reads the same backward as forward. Examples:
    Anna, Level, Civic, Madam, Noon.
    Implement a Python function that takes a word and returns true if it is palindrome,
    else false.
    In your solution, you have to use a doubly linked list where each node contains
    only one character of the input word.
    '''
    l=DList()
