...
/**
 * @brief Este servicio crea e inserta una nueva clave (key2)
 ...
 * @param key1 clave origen
 * @param key2 clave nueva sobre la que se copiaran el contenido de key1
 * @retval -1 en caso de que key1 no exista o cualquier error
 * @retval 0 en caso de exito**/
