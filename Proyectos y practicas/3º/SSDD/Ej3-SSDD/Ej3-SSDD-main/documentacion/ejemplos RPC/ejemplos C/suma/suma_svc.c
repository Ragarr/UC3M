...
int
_suma_1 (suma_1_argument *argp, void *result, struct svc_req *rqstp)
{
	return (suma_1_svc(argp->a, argp->b, result, rqstp));
}

int
_resta_1 (resta_1_argument *argp, void *result, struct svc_req *rqstp)
{
	return (resta_1_svc(argp->a, argp->b, result, rqstp));
}

static void
sumar_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	union {
	...
	if (!sumar_1_freeresult (transp, _xdr_result, (caddr_t) &result))
